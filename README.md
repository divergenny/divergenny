# 💫 Привет👋 моё имя Влад и я Java Разработчик

👨🏻‍🎓 В данный момент обучаюсь в университете МИРЭА - Российский технологический университет <br> 🏓 В свободное время играю в настольный теннис<br>📚 Изучаю Spring Boot и развиваюсь как Java разработчик<br>

Активно изучаю и пользуюсь: Java 8-20, PostgreSQL, jenkins, docker, spring(boot, cloud, security, data - реже),
немного rabbitmq (maven, postman, gradle, rest и всё что необходимо в отрасли Java разработки) <br>
В процессе обучения, выполнено большое количество теоретических, практических и тестовых заданий.
С основными проектами вы можете ознакомиться на моём аккаунте Github.
...
## 🌐 Социальные сети:
[![Telegram](https://img.shields.io/badge/-Telegram-red?color=blue&logo=telegram&logoColor=)](https://t.me/JavaDeveloperMoreThanJuinor)
